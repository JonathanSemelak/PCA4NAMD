...
def correlation_mulliken(rfile,e0file,e1file,temperature,alpha,framespertraj,filter,nframes_animation,amplitude):
    kB=0.000003173 #kB in hartree
    kt=kB*temperature
    print('Reading coordinates')
    natoms, nframes = get_natoms_nframes(mfile)
    print("natoms:", natoms)
    print("nframes:", nframes)
